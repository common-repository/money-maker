...
<div class="wrap">
	...
	<br/>
	<img src="<?php echo WP_PLUGIN_URL;?>/money-maker/banner.png" width="772" height="255"/>
	<div id="poststuff" class="metabox-holder">
		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<table style="text-align: center;">
					...
					<tr>
						<td><img src="<?php echo WP_PLUGIN_URL;?>/money-maker/img/post.png" /></td>
						<td style="padding: 0px 15px;">X</td>
						<td><img src="<?php echo WP_PLUGIN_URL;?>/money-maker/img/link.jpg" /></td>
						<td style="padding: 0px 15px;">=</td>
						<td><img src="<?php echo WP_PLUGIN_URL;?>/money-maker/img/pig.jpg" /></td>
					</tr>
					<tr>
		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<h2>You are 90 seconds <img src="<?php echo WP_PLUGIN_URL;?>/money-maker/img/clock.png" /> away from starting your automatic money making engine</h2>
				<b>Here how easy it is to put the most profitable affiliate network on the blogs to work for you.</b>
				<table style="padding-left:15px;">
					<tr><td>1. Choose the product you want to blog about (eg. The New Ipad)</td><td> <img alt="the new ipad" src="<?php echo WP_PLUGIN_URL;?>/money-maker/img/ipad.jpg"></td></tr>
				</table>
				<table style="padding-left:15px;">	
					<tr><td>2. Add the link from any E-commerce site to you post (we auto affiliate the link) </td><td><img alt="the new ipad" src="<?php echo WP_PLUGIN_URL;?>/money-maker/img/link.jpg"></td></tr>
				</table>
				<table style="padding-left:15px;">
					<tr><td>3. Publish your post and Earn! </td><td><img alt="the new ipad" src="<?php echo WP_PLUGIN_URL;?>/money-maker/img/publish.jpg"></td></tr>
				</table>
